...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notifications.messages'
        db.delete_column(u'mumlife_notifications', 'messages')

        # Adding M2M table for field messages on 'Notifications'
        m2m_table_name = db.shorten_name(u'mumlife_notifications_messages')
        ...
        db.create_unique(m2m_table_name, ['notifications_id', 'message_id'])


    def backwards(self, orm):
        # Adding field 'Notifications.messages'
        db.add_column(u'mumlife_notifications', 'messages',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Removing M2M table for field messages on 'Notifications'
        db.delete_table(db.shorten_name(u'mumlife_notifications_messages'))
    ...
    models = {
        ...
        u'mumlife.notifications': {
            ...
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'notification_messages'", 'blank': 'True', 'to': u"orm['mumlife.Message']"}),
