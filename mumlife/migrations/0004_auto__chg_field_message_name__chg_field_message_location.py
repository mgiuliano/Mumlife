...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mumlife_message', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.location'
        db.alter_column(u'mumlife_message', 'location', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Message.name'
        db.alter_column(u'mumlife_message', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Message.location'
        db.alter_column(u'mumlife_message', 'location', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'mumlife.member': {
            ...
            'units': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
