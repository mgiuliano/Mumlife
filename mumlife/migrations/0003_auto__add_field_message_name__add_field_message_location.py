...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mumlife_message', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Message.location'
        db.add_column(u'mumlife_message', 'location',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mumlife_message', 'name')

        # Deleting field 'Message.location'
        db.delete_column(u'mumlife_message', 'location')
